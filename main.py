...
from loadbatch import read_image_to_tfrecode, read_and_decode
...
n_epoch = 100
batch_size = 40
read_image_to_tfrecode("./dataset/","hh.tfrecords")
train_imgs, train_labels = read_and_decode("hh.tfrecords")
...
with tf.Session() as sess:
    ...
    for epoch in range(n_epoch):
        ...
        for i in range(40):
            ...
            train_loss += err
            train_acc += ac
        print('Epoch %d, train loss: %f, train acc: %f' % (epoch, train_loss, train_acc))
